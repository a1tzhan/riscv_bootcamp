...
VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.sv --exe --trace ./test/{1}/{1}_dpi.cpp minirv_top_dpi.cpp ./emulator/minirv_emu.cpp"#verilate dpi
