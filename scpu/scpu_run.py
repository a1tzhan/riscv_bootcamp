...
#MODULES.append("fetch_unit")
#MODULES.append("branch_logic")
MODULES.append("scpu")

# Linux commands invoked within this script.
# Verilator command to generate C++ and Makefiles.
#VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe --trace ./test/{1}/{1}_tb.cpp"                              #verilate tb
#VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe --trace ./test/{1}/{1}_cosim.cpp ./emulator/bitty_emu.cpp"  #verilate cosim
VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe --trace ./test/{1}/{1}_dpi.cpp scpu_top_dpi.cpp ./emulator/scpu_emu.cpp ./generator/scpu_instruction_generator.cpp"#verilate dpi
